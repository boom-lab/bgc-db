    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AscentTimeOut', models.CharField(blank=True, max_length=50, null=True)),
                ('AtDialCmd', models.CharField(blank=True, max_length=50, null=True)),
                ('AltDialCmd', models.CharField(blank=True, max_length=50, null=True)),
                ('BuoyancyNudge', models.CharField(blank=True, max_length=50, null=True)),
                ('BuoyancyNudgeInitial', models.CharField(blank=True, max_length=50, null=True)),
                ('ConnectTimeOut', models.CharField(blank=True, max_length=50, null=True)),
                ('CpActivationP', models.CharField(blank=True, max_length=50, null=True)),
                ('DeepProfileDescentTime', models.CharField(blank=True, max_length=50, null=True)),
                ('DeepProfileBuoyancyPos', models.CharField(blank=True, max_length=50, null=True)),
                ('DeepProfilePressure', models.CharField(blank=True, max_length=50, null=True)),
                ('DownTime', models.CharField(blank=True, max_length=50, null=True)),
                ('FloatId', models.CharField(blank=True, max_length=50, null=True)),
                ('FullExtension', models.CharField(blank=True, max_length=50, null=True)),
                ('FullRetraction', models.CharField(blank=True, max_length=50, null=True)),
                ('IceMonths', models.CharField(blank=True, max_length=50, null=True)),
                ('HpvRes', models.CharField(blank=True, max_length=50, null=True)),
                ('MaxAirBladder', models.CharField(blank=True, max_length=50, null=True)),
                ('MaxLogKb', models.CharField(blank=True, max_length=50, null=True)),
                ('MissionPrelude', models.CharField(blank=True, max_length=50, null=True)),
                ('OkVacuum', models.CharField(blank=True, max_length=50, null=True)),
                ('PActivationBuoyancyPosition', models.CharField(blank=True, max_length=50, null=True)),
                ('ParkDescentTime', models.CharField(blank=True, max_length=50, null=True)),
                ('ParkBuoyancyPos', models.CharField(blank=True, max_length=50, null=True)),
                ('ParkPressure', models.CharField(blank=True, max_length=50, null=True)),
                ('PnPCycleLen', models.CharField(blank=True, max_length=50, null=True)),
                ('TelemetryRetry', models.CharField(blank=True, max_length=50, null=True)),
                ('TimeOfDay', models.CharField(blank=True, max_length=50, null=True)),
                ('UpTime', models.CharField(blank=True, max_length=50, null=True)),
                ('Verbosity', models.CharField(blank=True, max_length=50, null=True)),
                ('DebugBits', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('MISSION', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='env_data.mission', to_field='PROFILE_ID')),
